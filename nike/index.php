...
<?php include_once "header.php"; ?>
    ...
    <div class="container">
        ...
        <div class="container-about">
            <div id="trailer" class="section d-flex justify-content-center embed-responsive embed-responsive-16by9 mt-5 pb-5">

            <iframe width="1120" height="630" src="https://www.youtube.com/embed/3jk7KFvjWVI?autoplay=1&mute=1"
            ...
            <div class="additional-text">
                <h1 class="big-text">YOU'RE HERE FOR A REASON</h1>
                <p class="small-text">The Jordan Family DNA is in all of us, with hard work, determination,
                swagger, and drive you can accomplish whatever you put your mind to,
                because you’re here for a reason.
                </p>
                <div class="button-text"><a href="men.php">Explore More</a></div>
            </div>
        </div>
        ...
        <div class="product_section layout_padding">
            <div class="container-product">
               <div class="row">
                  <div class="col-sm-12">
                     <h1 class="product_taital">SHOP NEW PRODUCT</h1>
                     <p class="product_text">Just Do It</p>
                  </div>
               </div>
               <div class="product_section_2 layout_padding">
                  ...
                  <div class="seemore_bt"><a href="men.php">See More</a></div>
               </div>
            </div>
         </div>
        ...
        <!-- img /poster -->
        <div id="img-gif-cards" >
            <img src="./assests/img/poster.webp" alt="" class="">
        </div>
        
        <!-- additonal-text -->
        <div class="additional-text">
            <p class="small-text-p">Just In</p>
            <h1 class="big-text">NIKE AIR MAX PULSE</h1>
            <p class="small-text">Inspired by the energy of London's music scene comes the Air Max 
                Pulse. A tough silhouette infused with an unreal sensation of Air
            </p>
            <div class="button-text"><a href="men.php">Shop Now</a></div>

        </div>

        <!-- img /poster -->
        <div id="img-gif-cards-1">
            <img src="./assests/img/img_xiii.webp" alt="" class="">
        </div>

        <!-- additonal-text -->
        <div class="additional-text">
            <p class="small-text-p">NIKE APP Early Access</p>
            <h1 class="big-text">AIR JORDAN XXXVII LOW 'STUNT'</h1>
            <p class="small-text">The Air Jordan XXXVII Low 'Stunt' colourway tricks out the ultimate performance shoe to make a bold statement</p>
            <div class="button-text"><a href="men.php">Shop</a></div>
        </div>

        <p class="arrivals_text">New Arrivals</p>
        <div class="arrivals_section_2">
           <div class="row">
              <div class="col-md-4">
                 <div><img src="./assests/img/img-arrivals/69bb9b94-5771-4b28-b436-4053764876c6.webp" class="arrivals_img"></div>
                 <div class="btn_main"><a href="men.php">Men's</a></div>
              </div>
              <div class="col-md-4">
                 <div><img src="./assests/img/img-arrivals/79b50ced-3832-4aa4-bc3a-a963c5950e1b.webp" class="arrivals_img"></div>
                 <div class="btn_main"><a href="women.php">Women's</a></div>
              </div>
              <div class="col-md-4">
                 <div><img src="./assests/img/img-arrivals/cee09af6-6ecc-4eb0-8148-eac6f9153931.webp" class="arrivals_img"></div>
                 <div class="btn_main"><a href="kids.php">Kid's</a></div>
              </div>
           </div>
        </div>

    <!-- Footer -->
    <!-- footer-1-detail nike and jordan -->
    ...
    <!-- footer-last-service-link-and address -->
    <footer class="text-center text-lg-start mt-5 text--none" style="background-color: #000;">
            ...
            <div class="row  align-self-center">
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li>
                            <a href="login.php" class="text-white text--none-1">BECOME A MEMBER</a>
                        </li>
                        <li>
                            <a href="login.php" class="text-white">SIGN UP FOR EMAIL</a>
                        </li>
                        <li>
                ...
                <!--Grid column-->
                <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                    <h5 class="text-uppercase mb-0">Get help</h5>
                    <ul class="list-unstyled">
                        <li>
                            <a href="#!" class="text-secondary">Order Status</a>
                        </li>
                        <li>
                            <a href="#!" class="text-secondary">Delivery</a>
                        </li>
                        <li>
                            <a href="#!" class="text-secondary">Returns</a>
                        </li>
                        <li>
                            <a href="#!" class="text-secondary">Payment Options</a>
                        </li>
                        <li>
                ...
                <!--Grid column-->
                <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                    <h5 class="text-uppercase mb-0">On Nike</h5>
                    <ul class="list-unstyled">
                        <li>
                            <a href="#!" class="text-muted">News</a>
                        </li>
                        <li>
                            <a href="#!" class="text-muted">Career</a>
                        </li>
                        <li>
                            <a href="#!" class="text-muted">Investor</a>
                        </li>
                        <li>
                            <a href="#!" class="text-muted">Sustainability</a>
                        </li>
                    </ul>
                </div>
                <!--Grid column-->
                <div class="container col-lg-2 col-md-6 mb-4 mb-md-0">
                    <a class="text-decoration-none" href="https://twitter.com/Nike">
                        <svg class="social-link-icon" width="30px" fill="#456"
                    ...
                    <a class="text-decoration-none" href="https://www.facebook.com/nike" data-pre="ILink">
                        <svg class="social-link-icon" width="30px" fill="#456" height="30px" viewBox="0 0 24 24">
                            <path
                    ...
                    <a class="text-decoration-none" href="https://www.youtube.com/user/nike" data-pre="ILink">
                        <svg class="social-link-icon" width="30px" fill="#456" height="30px" viewBox="0 0 24 24">
                            <path
                    ...
                    <a class="text-decoration-none" href="https://instagram.com/nike">
                        <svg class="social-link-icon" width="30px" fill="#456" height="30px" viewBox="0 0 24 24">
                            <path
        ...
        <!-- Copyright -->
        <nav class="navbar p-3 text-white" style="background-color: rgba(0, 0, 0, 0.87);">
            <!-- left -->
            <div class="justify-content-start p-3 text-white">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt" viewBox="0 0 16 16">
                    <path d="M12.166 8.94c-.524 1.062-1.234 2.12-1.96 3.07A31.493 31.493 0 0 1 8 14.58a31.481 31.481 0 0 1-2.206-2.57c-.726-.95-1.436-2.008-1.96-3.07C3.304 7.867 3 6.862 3 6a5 5 0 0 1 10 0c0 .862-.305 1.867-.834 2.94zM8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10z"/>
                    <path d="M8 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                </svg>
                <a class="text-white px-3" href="#">VietNam</a>
                © 2023 Nike, Inc. All Rights Reserved
            </div>
            <!-- right -->
            <div class="navbar justify-content-end p-2">
                <ul class="nav">
                    <li class="nav-item dropup">
                        ...
                        <ul class="dropdown-menu    ">
                            ...
                            <li><a class="dropdown-item" href="#">Terms of sale</a></li>
                            <li><a class="dropdown-item" href="#">Terms of use</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="#">Send comments and feedback</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link link-light" href="#">Terms of sale</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link link-light" href="#">Terms of use</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link link-light" href="#">Nike Privacy Policy</a>
                    </li>
                </ul>
            </div>
        </nav>
    ...
    <script src="./assests/js/header.js">
    </script>
</body>
</html>
