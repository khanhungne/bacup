...
<?php include "header.php"; ?>
    ...
    <div class="product_section layout_padding mt-3">
        ...
        <div class="container container-product pt-3">
           <div class="row">
              <div class="col-sm-12">
           ...
           <div class="product_section_2 layout_padding">
              ...
              <form action="men.php"> 
                ...
                <button type="submit" id="custom-submit" class="d-none">submit</button>
                <div class="seemore_bt"><a href="#" onclick="event.preventDefault();document.querySelector('#custom-submit').click()">See more</a></div>
              </form>
           </div>
        </div>
     </div>
