<?php
    ...
    if(isset($_POST['login'])){
        ...
        if(empty($user)){
            ...
            $result = mysqli_query($conn, "SELECT * from tb_user where user ='$user' and pass = '$pass'");
...
<header>
    ...
    <div class="container">
        <div class="img-logo">
            <img class="logo" src="./assests/img/nikee.jpg" alt="Logo">
        </div>
        <p class="subheading">YOUR ACCOUNT FOR<br>EVERYTHING NIKE</p>
        <div class="login-box">
            <div class="form" >
                <form class="login-form" method="post" action="login.php">
                    ...
                    <label class="check" for="remember_me">Keep me signed in</label>
        ...
        <div class="container p-4 text-white">
            ...
            <div class="row  align-self-center">
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                    <h6 class="text-uppercase">FIND A STORE</h6>
