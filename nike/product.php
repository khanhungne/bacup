...
<head>
    ...
    <title>Product</title>
    <link rel="stylesheet" href="./assests/css/produdetail.css">
...
<?php include "header.php";
    ...
    $resultImgs = mysqli_query($conn, "SELECT * from tb_products join tb_images on tb_images.product_id = tb_products.id where tb_products.id = ".$searchId." ");
            ...
            <div class="content row">
                <div class="content-left col-md-4 col-sm-9">
                    <div class="content-img ">
                        <img src="<?php echo $productImgs[0][7]?>" alt="">
                        <img src="<?php echo $productImgs[2][7]?>" alt="">
                    </div>
                </div>  
                <div class="content-left col-md-4 col-sm-9">
                    <div class="content-img ">
                        <img src="<?php echo $productImgs[1][7]?>" alt="">
                        <img src="<?php echo $productImgs[3][7]?>" alt="">
                    </div>
                </div>
                ...
                <div class="content-right col-md-3 col-sm-2">
                    ...
                    <div class="content-price">
                        <p><?php echo $productDetails["price"]?><sup>đ</sup></p>
                    </div>
                    ...
                    <div class="content-button">
                        <a href="#"><button class="btn-product-add"><i class="fas fa-shopping-cart icon-product"></i>Add the item</button class="btn-product"></a>  
                        <a href="#"><button class="btn-product"><i class="fas fa-shopping-cart icon-product"></i>Buy</button></a>
                    </div>
            ...
            <div class="row  align-self-center">
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li>
                            <a href="#!" class="text-white">SIGN UP FOR EMAIL</a>
                        </li>
                        <li>
