...
<body>
    ...
    <div class="product_section layout_padding mt-3">
        ...
        <div class="container-product pt-3">
           <div class="row">
              <div class="col-sm-12">
                 <h1 class="product_taital">PRODUCT</h1>
           ...
           <div class="product_section_2 layout_padding">
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <a href="" class="product-card">
                            <div class="product_box">
                                <img src="./assests/img/producthome/Airjordan1midSE.webp" class="image_1">
                                <p class="bursh_text">Air jordan 1 Low</p>
                                <p class="lorem_text">Man's Shoes</p>
                                <p class="lorem_text">1 Colour</p>
                                <p class="bursh_text">3,254,649đ</p>
                                <!-- <div class="btn_main">
                                    <div class="buy_bt">
                                        <ul>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <a href="" class="product-card">
                            <div class="product_box">
                                <img src="./assests/img/producthome/airjordan1low.webp" class="image_1">
                                <p class="bursh_text">Air jordan 1 Low</p>
                                <p class="lorem_text">Man's Shoes</p>
                                <p class="lorem_text">1 Colour</p>
                                <p class="bursh_text">3,254,649đ</p>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <a href="" class="product-card">
                            <div class="product_box">
                                <img src="./assests/img/producthome/airjordan1elevatehigh.webp" class="image_1">
                                <p class="bursh_text">Air jordan 1 Low</p>
                                <p class="lorem_text">Man's Shoes</p>
                                <p class="lorem_text">1 Colour</p>
                                <p class="bursh_text">3,254,649đ</p>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <a href="" class="product-card">
                            <div class="product_box">
                                <img src="./assests/img/producthome/airjordan1sewhite.webp" class="image_1">
                                <p class="bursh_text">Air jordan 1 Low</p>
                                <p class="lorem_text">Man's Shoes</p>
                                <p class="lorem_text">1 Colour</p>
                                <p class="bursh_text">3,254,649đ</p>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <a href="" class="product-card">
                            <div class="product_box">
                                <img src="./assests/img/producthome/airjordan1midseblue.webp" class="image_1">
                                <p class="bursh_text">Air jordan 1 Low</p>
                                <p class="lorem_text">Man's Shoes</p>
                                <p class="lorem_text">1 Colour</p>
                                <p class="bursh_text">3,254,649đ</p>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <a href="" class="product-card">
                            <div class="product_box">
                                <img src="./assests/img/producthome/airjordanelevatehigh.webp" class="image_1">
                                <p class="bursh_text">Air jordan 1 Low</p>
                                <p class="lorem_text">Man's Shoes</p>
                                <p class="lorem_text">1 Colour</p>
                                <p class="bursh_text">3,254,649đ</p>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <a href="" class="product-card">
                            <div class="product_box">
                                <img src="./assests/img/producthome/airjordanelevatelow.webp" class="image_1">
                                <p class="bursh_text">Air jordan 1 Low</p>
                                <p class="lorem_text">Man's Shoes</p>
                                <p class="lorem_text">1 Colour</p>
                                <p class="bursh_text">3,254,649đ</p>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <a href="" class="product-card">
                            <div class="product_box">
                                <img src="./assests/img/producthome/airjordanelevatehighred.webp" class="image_1">
                                <p class="bursh_text">Air jordan 1 Low</p>
                                <p class="lorem_text">Man's Shoes</p>
                                <p class="lorem_text">1 Colour</p>
                                <p class="bursh_text">3,254,649đ</p>
            ...
            <div class="row  align-self-center">
                <div class="col-lg-3 col-md-6 mb-4">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li>
                            <a href="login.html" class="text-white text--none-1">BECOME A MEMBER</a>
                        </li>
                        <li>
                            <a href="login.html" class="text-white">SIGN UP FOR EMAIL</a>
                        </li>
                        <li>
